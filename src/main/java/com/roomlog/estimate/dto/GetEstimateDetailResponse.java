...
@Getter
public class GetEstimateDetailResponse {
    ...
    private GetEstimateDetailResponse(Estimate estimate, List<EstimateDefect> estimateDefects) {
    ...
    public static GetEstimateDetailResponse of(Estimate estimate, List<EstimateDefect> estimateDefects) {
        return new GetEstimateDetailResponse(estimate, estimateDefects);
    }
