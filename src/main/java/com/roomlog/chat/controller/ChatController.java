...
public class ChatController {
    ...
    @Operation(summary = "C02. 메시지 전송", description = """
            ...
            - defect_id: "등록된 하자에서 선택하기"(C04)로 고른 하자 ID. 직접 입력한 질문이면 생략합니다.

            defect_id를 실어 보내면 앱 사용법 대신 그 하자를 근거로 답하며, 심각도에 따라 셀프 조치 또는
            관리사무소·전문 업체 연락을 안내합니다. 이때 guide는 무시되고 source는 항상 GPT입니다.
            대표 집에 속하지 않은 하자를 보내면 DEFECT_003(403)으로 응답합니다.
