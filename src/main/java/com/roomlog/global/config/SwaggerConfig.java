    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                ...
                .tags(List.of(
                        ...
                        new Tag().name("5. Defect").description("방 하자 목록 조회 API"),
                        new Tag().name("6. Repair").description("업체 조회, 견적 요청/조회, 수리 내역 조회, 수리 완료 등록 API"),
                        new Tag().name("7. Auth").description("회원가입, 로그인, 토큰 재발급 API"),
                        new Tag().name("8. MyPage").description("프로필 조회, 내 정보 수정, 회원 탈퇴 API"),
