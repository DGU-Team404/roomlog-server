...
public class DefectController {
    ...
    @Operation(summary = "V05. 자가 수리 안내 조회", description = """
            ...
            [가능한 경우] description(수리 가능 사유), video_url(유튜브 예시 영상 검색 결과), items(구매 필요 목록 + 쿠팡/G마켓 링크), total_cost(최저가 기준 예상 비용)가 내려갑니다.

            [불가능한 경우] description(수리 불가 사유)만 내려가며 video_url은 null, items는 빈 배열, total_cost는 0입니다.
