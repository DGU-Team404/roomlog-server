...
public class AuthController {
    ...
    @Operation(summary = "A01. 회원가입", description = "이메일, 비밀번호, 닉네임으로 회원가입합니다.", tags = "7. Auth")
    @PostMapping("/signup")
    ...
    @Operation(summary = "A02. 로그인", description = "이메일, 비밀번호로 로그인하고 액세스 토큰을 발급받습니다.", tags = "7. Auth")
    @PostMapping("/login")
    ...
    @Operation(summary = "A03. 토큰 재발급", description = "리프레시 토큰으로 새로운 액세스 토큰을 발급받습니다.", tags = "7. Auth")
    @PostMapping("/refresh")
