...
public class UserController {
    ...
    @Operation(summary = "M01. 내 프로필 조회", description = "로그인한 사용자의 프로필 정보를 조회합니다.", tags = "8. MyPage")
    @GetMapping
    ...
    @Operation(summary = "M02. 내 정보 수정", description = "닉네임을 수정합니다.", tags = "8. MyPage")
    @PatchMapping
    ...
    @Operation(summary = "M04. 회원 탈퇴", description = "계정을 삭제합니다. (soft delete)", tags = "8. MyPage")
    @DeleteMapping
